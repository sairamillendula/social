...
class StatusUpdatesControllerTest < ActionController::TestCase
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post :create, status_update: { body: @status_update.body, timestamp: @status_update.timestamp, to_user_id: @status_update.to_user_id, user_id: @status_update.user_id }
    end
  ...
  test "should update status_update" do
    put :update, id: @status_update, status_update: { body: @status_update.body, timestamp: @status_update.timestamp, to_user_id: @status_update.to_user_id, user_id: @status_update.user_id }
    assert_redirected_to status_update_path(assigns(:status_update))
  end
